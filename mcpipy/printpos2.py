...
count=0
lastpos=(-90,0,-90)
digitpos=(-102, 10, -100)#where binary code will be pasted. Note that it will ALWAYS be pasted toward positive x axis.
p2dpos=(-102, 10, -102) #other player's binary code position; if it exists.
posblock=block.CLAY
